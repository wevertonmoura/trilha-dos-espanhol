...
export default function PixModal({
  ...
  // ✨ CORREÇÃO DE UX MOBILE: Rola automaticamente para o topo e gerencia o scroll
  useEffect(() => {
    // 1. Força a página a rolar para o topo imediatamente ao abrir o PIX
    window.scrollTo({ top: 0, behavior: 'smooth' });

    // 2. Trava o scroll do fundo da página apenas no desktop para não bugar celulares pequenos
  ...
  return (
    <>
      {/* OVERLAY TELA CHEIA (SUPERIOR A TUDO: z-[99999]) */}
      <div className="fixed inset-0 z-[99999] overflow-y-auto bg-slate-900/85 backdrop-blur-md animate-in fade-in duration-300">
        
        {/* CONTAINER COM SCROLL PERFEITO PARA CELULARES PEQUENOS */}
        <div className="min-h-full w-full flex items-center justify-center p-3 sm:p-6 py-8">
          
          <div className="relative w-full max-w-lg bg-white border-2 border-sky-400/40 rounded-[2rem] sm:rounded-[2.5rem] p-5 sm:p-8 shadow-[0_20px_60px_rgba(0,0,0,0.5)] text-center space-y-5 text-slate-800 my-auto">
            ...
            {statusPagamento === 'pago' ? (
              ...
              >
                ...
                <div className="space-y-2 text-left pt-1 max-h-48 overflow-y-auto pr-1">
              ...
              /* ============================================================================
                 ⏳ TELA DE PAGAMENTO (Otimizada para Celulares Pequenos)
                 ============================================================================ */
              <>
                ...
                {tempoRestante > 0 ? (
                  ...
                  <div className="space-y-4">
                    ...
                    {/* BLOCO DO QR CODE COMPACTO PARA MOBILE */}
                    ...
                    <div className="border-t border-slate-100 pt-3 mt-1">
                      <button 
                        ...
                        className="text-slate-400 hover:text-slate-700 text-[10px] sm:text-[11px] font-bold uppercase tracking-widest underline cursor-pointer transition-colors"
                      >
